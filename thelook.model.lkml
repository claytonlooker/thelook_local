...
explore: order_items {
  ...
  join: full_inventory_items {
    relationship: many_to_one
    sql_on: ${order_items.id} = ${full_inventory_items.id} ;;
  }
...
#    type: full_outer
  ...
  join: products {
    relationship: many_to_one
    sql_on: ${products.id} = ${full_inventory_items.product_id} ;;
  }
...
#     type: left_outer
#     sql_on: ${distribution_centers.id} = ${full_inventory_items.product_distribution_center_id} ;;
#     relationship: many_to_one
#   }
 }
